...
This program transforms an unstructured data file from the UV spectroscopy machine, into an organized csv file to be used in data analyses. This program also skips the tedious task of entering each sample ID into the UV-spectroscopy machine by accepting a custom excel file indicating the samples in the run.
