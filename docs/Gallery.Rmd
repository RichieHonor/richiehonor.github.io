...
#### Here you can view some of the images I created in R.
...
![](Gallery/Mule Harvest North America and Hawaii 2014-2016_2.png)




**Figure 8.** Heat map demonstrating the number of mule deer harvested in North America. 
...
![](Gallery/Multiplot_representation.png)


**Figure 9.** Multipanel plot demonstrating the representation of the hunter population of the state (orange bars; state name redacted) in comparison to the entire population of the state (blue bars).
...
**Figure 10.** Association of leaf quality (PC1) with *Alliaria petiolata* rosette size and
...
**Figure 11.** A general defence trade-off model of defence traits along a gradient of enemy abundance.
...
**Figure 12.** Simulated data demonstrating the predicted relative fitness (W) when enemies are present (E+) and absent (E-) across a gradient of susceptible (red) and resistant (blue) genotypes. 
...
**Figure 13.** Linear approximations of reaction norms for fitness (W) measured in a susceptible (S, red) and a resistant genotype (R, blue). The difference in y-intercepts (WS0 – WR0) provides an estimate of the cost of resistance, while the slopes (–W0/E0) estimate of the benefits of defence.
